		...
		<c:when test="${empty currentUser.firstName}">
        	<div class="form-group">
	    		<form:label for="firstName" path="firstName">First Name</form:label>
	   			<form:input type="text" class="form-control form-control-lg" id="firstName" path="firstName" placeholder="Enter your first name.." name="firstName"></form:input>
	  		</div>
    	</c:when>
    	<c:otherwise>
        	<div class="form-group">
	    		<form:label for="firstName" path="firstName">First Name</form:label>
	   			<form:input type="text" class="form-control form-control-lg" id="firstName" path="firstName" placeholder="${currentUser.firstName}" name="firstName"></form:input>
	  		</div>
      	</c:otherwise>
      </c:choose>
		...
		<c:when test="${empty currentUser.lastName}">
        	<div class="form-group">
	    		<form:label for="lastName" path="lastName">First Name</form:label>
	   			<form:input type="text" class="form-control form-control-lg" id="lastName" path="lastName" placeholder="Enter your last name.." name="lastName"></form:input>
	  		</div>
    	</c:when>
    	<c:otherwise>
        	<div class="form-group">
	    		<form:label for="lastName" path="lastName">First Name</form:label>
	   			<form:input type="text" class="form-control form-control-lg" id="lastName" path="lastName" placeholder="${currentUser.lastName}" name="lastName"></form:input>
	  		</div>
      	</c:otherwise>
      </c:choose>
	  ...
	  <c:choose>
		<c:when test="${empty currentUser.bio}">
        	<div class="form-group">
	    		...
	    		<form:textarea class="form-control form-control-lg" id="bio" path="bio" placeholder="Enter bio.." rows="3" name="bio"></form:textarea>
	  		</div>
    	</c:when>
    	<c:otherwise>
        	<div class="form-group">
	    		<form:label for="bio" path="bio">Bio</form:label>
	    		<form:textarea class="form-control form-control-lg" id="bio" path="bio" placeholder="${currentUser.bio}" rows="3" name="bio"></form:textarea>
	  		</div>
      	</c:otherwise>
      </c:choose>	 
